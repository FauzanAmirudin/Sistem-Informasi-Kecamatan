...
<div class="btn-group" role="group">
    <a href="{{ route('admin-desa.penduduk.show', $penduduk) }}" class="btn btn-info">
...
<div class="row">
    <div class="col-lg-8">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form action="{{ route('admin-desa.penduduk.update', $penduduk) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="{{ route('admin-desa.penduduk.show', $penduduk) }}" class="btn btn-secondary me-md-2">
